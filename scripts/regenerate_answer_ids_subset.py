"""Regenerate answers for arbitrary question IDs listed in a CSV file."""
...
from backend.evaluation.subset_answer_regeneration import generate_answer_ids_subset
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    summary = generate_answer_ids_subset(
        ids_csv_path=args.ids_csv,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="Regenerate QA answers for IDs listed in a CSV file.")
    parser.add_argument("--ids-csv", required=True)
    parser.add_argument("--retrieval-results", required=True)
    parser.add_argument("--output", default=str(output_dir / "generated_answers_ids_subset.jsonl"))
